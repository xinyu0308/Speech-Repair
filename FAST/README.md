...
This repository provides an implementation of the **Formant-Aligned Spectral Transformation (FAST)** module for vowel correction in dysarthric Mandarin speech.
...
### Step 3 — Run Inference with FAST
